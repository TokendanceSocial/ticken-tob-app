...
export interface AdminInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'eventsForOwner', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: 'eventsForUser', values: [PromiseOrValue<string>]): string;
  ...
  decodeFunctionResult(functionFragment: 'eventsForOwner', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'eventsForUser', data: BytesLike): Result;
...
export type proxy_deployedEvent = TypedEvent<[string, string], proxy_deployedEventObject>;
...
export interface Admin extends BaseContract {
  ...
  filters: {
    ...
    proxy_deployed(event_proxy_address?: null, owner_address?: null): proxy_deployedEventFilter;
  };
  ...
  estimateGas: {
    ...
    eventsForOwner(owner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;

    eventsForUser(user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
